					...
					<div class='form-group'>
						...
						<div class='col-md-10'>
							<select class='form-control' name='jenis_kelamin2' required>
								<option value='Laki-Laki' <?php if ($data[4] == 'Laki-Laki') {
																echo 'selected';
															} ?>>Laki-Laki</option>
								<option value='Perempuan' <?php if ($data[4] == 'Perempuan') {
																echo 'selected';
															} ?>>Perempuan</option>
							</select>
						</div>
					...
					<div class='form-group'>
						...
						<div class='col-md-10'>
							<select class='form-control' name='agama2' required>
								<option value='Islam' <?php if ($data[5] == 'Islam') {
															echo 'selected';
														} ?>>Islam</option>
								<option value='Khatolik' <?php if ($data[5] == 'Khatolik') {
																echo 'selected';
															} ?>>Khatolik</option>
								<option value='Protestan' <?php if ($data[5] == 'Protestan') {
																echo 'selected';
															} ?>>Protestan</option>
								<option value='Hindu' <?php if ($data[5] == 'Hindu') {
															echo 'selected';
														} ?>>Hindu</option>
								<option value='Budha' <?php if ($data[5] == 'Budha') {
															echo 'selected';
														} ?>>Budha</option>
							</select>
						</div>
					...
					<div class='form-group'>
						...
						<div class='col-md-10'>
							<select class='form-control' name='gol_darah2'>
								<option value='A' <?php if ($data[12] == 'A') {
														echo 'selected';
													} ?>>A</option>
								<option value='B' <?php if ($data[12] == 'B') {
														echo 'selected';
													} ?>>B</option>
								<option value='AB' <?php if ($data[12] == 'AB') {
														echo 'selected';
													} ?>>AB</option>
								<option value='O' <?php if ($data[12] == 'O') {
														echo 'selected';
													} ?>>O</option>
							</select>
						</div>
