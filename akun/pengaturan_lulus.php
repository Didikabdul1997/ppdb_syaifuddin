								...
								<tbody>
									...
									while ($data = mysql_fetch_row($query)) {
										...
										<td width='35' align='center'>
											<a class='btn btn-sm btn-danger' href="pengaturan_lulus.php?tombol=delete&adm_id='<?= $data[0]; ?>'" title="Hapus" onclick="return confirm('Apakah anda yakin ingin keluar ?')">Hapus</a></td>
									<?php
										echo "</tr>";
										$i++;
									}
