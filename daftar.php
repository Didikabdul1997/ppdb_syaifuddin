        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <a href="index.php"><img src="images/mts 0.png" alt=""></a>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="page-caption">
                        ...
                        <div class="page-breadcrumb">
                            <ol class="breadcrumb">
                                <li><a href="home.php" style="color: white;"><b>Beranda</b></a></li>
                                <li class="active" style="color: white;"><b>Daftar Sekarang</b></li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="widget widget-contact">
                        ...
                        <address>
                            <strong>Panitia PPDB</strong>
                            <br> Jln Ahmad Yani No 12,
                            <br> Sukorejo, POS 62115
                            <br>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="footer-widget footer-social">
                            <!-- social block -->
                            <h2 class="widget-title">Upan Sosial</h2>
                            <ul class="listnone">
                                <li>
